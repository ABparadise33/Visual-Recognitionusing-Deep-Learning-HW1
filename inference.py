...
# Corresponds to the full fine-tuning weights filename
...
class InferenceDataset(Dataset):
    ...
    def __init__(self, root_dir, transform=None):
        ...
        self.image_paths = [
            p for p in self.image_paths if p.lower().endswith(valid_extensions)
        ]
...
def main():
    ...
    print(
        "🚀 Starting 10-Crop TTA Inference (ResNet-101 Full Fine-tuning)..."
    )
    ...
    # Must match the architecture defined in train4.py
